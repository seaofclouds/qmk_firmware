...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[0] = LAYOUT(
		...
		KC_LCTL, KC_LALT, KC_LGUI, KC_SPC, LT(0,KC_SPC), KC_SPC, MO(1), KC_RGUI, KC_RALT, KC_NO, KC_RCTL),
	...
	[2] = LAYOUT(
		...
		KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_LEFT, KC_DOWN, KC_TRNS, KC_RGHT),
};
